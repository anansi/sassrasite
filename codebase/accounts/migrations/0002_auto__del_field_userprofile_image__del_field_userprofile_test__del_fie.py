...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('accounts_userprofile', 'test')

        # Deleting field 'UserProfile.cropping'
        db.delete_column('accounts_userprofile', 'cropping')

        # Adding field 'UserProfile.front_45_headshot'
        db.add_column('accounts_userprofile', 'front_45_headshot',
    ...
    def backwards(self, orm):
        ...
        db.add_column('accounts_userprofile', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='a', max_length=100),
                      keep_default=False)

        # Adding field 'UserProfile.test'
        db.add_column('accounts_userprofile', 'test',
                      self.gf('django.db.models.fields.files.ImageField')(default='a', max_length=100),
                      keep_default=False)

        # Adding field 'UserProfile.cropping'
        db.add_column('accounts_userprofile', 'cropping',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.front_45_headshot'
        db.delete_column('accounts_userprofile', 'front_45_headshot')
