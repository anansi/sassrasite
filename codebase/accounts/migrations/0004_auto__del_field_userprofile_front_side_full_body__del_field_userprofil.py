...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.side_headshot'
        db.add_column('accounts_userprofile', 'side_headshot',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.side_full_body'
        db.add_column('accounts_userprofile', 'side_full_body',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.side_headshot'
        db.delete_column('accounts_userprofile', 'side_headshot')

        # Deleting field 'UserProfile.side_full_body'
        db.delete_column('accounts_userprofile', 'side_full_body')
    ...
    models = {
        ...
        'accounts.userprofile': {
            ...
            'side_full_body': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
            'side_headshot': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
