...
STATICFILES_DIRS = (
    ...
    #'/stuntperformers/static/',
    #'/stuntperformers/static/images',
    #'/startup/static/'
    #'/stuntperformers/static/',
)
...
SECRET_KEY = '-22-y1qgffs97t2aeugezt&ay+c*y7r58x2lb@r%b4&_@dqsrg'
